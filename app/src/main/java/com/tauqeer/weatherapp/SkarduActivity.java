...
public class SkarduActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_skardu);
        dateView = (TextView) findViewById(R.id.date_skardu);
        weatherType = (TextView) findViewById(R.id.weather_type_skardu);
        feelsLike = (TextView) findViewById(R.id.feels_like_skardu);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_skardu);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_skardu);
        toolbar = (Toolbar) findViewById(R.id.toolbar_skardu);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_skardu);
        setTitle("City Weather Info");
        getData(35.288, 75.633);
    }
