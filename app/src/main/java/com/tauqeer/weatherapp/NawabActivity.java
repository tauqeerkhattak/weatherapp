...
public class NawabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_naw);
        dateView = (TextView) findViewById(R.id.date_naw);
        weatherType = (TextView) findViewById(R.id.weather_type_naw);
        feelsLike = (TextView) findViewById(R.id.feels_like_naw);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_naw);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_naw);
        toolbar = (Toolbar) findViewById(R.id.toolbar_naw);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_naw);
        setTitle("City Weather Info");
        getData( 26.2452915, 68.4040229);
    }
