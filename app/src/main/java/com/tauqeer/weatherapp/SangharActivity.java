...
public class SangharActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sanghar);
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_sanghar);
        dateView = (TextView) findViewById(R.id.date_sanghar);
        weatherType = (TextView) findViewById(R.id.weather_type_sanghar);
        feelsLike = (TextView) findViewById(R.id.feels_like_sanghar);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_sanghar);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_sanghar);
        toolbar = (Toolbar) findViewById(R.id.toolbar_sanghar);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_sanghar);
        setTitle("City Weather Info");
        getData(26.0470447, 68.9492402);
    }
    ...
    public static boolean setNextWeekForecast () {
        try{
            ...
            System.out.println("Height: "+nextWeekForecast.getHeight());
            return true;
        }catch (Exception e) {
