...
public class KhairpurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khairpur);
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_khairpur);
        dateView = (TextView) findViewById(R.id.date_khairpur);
        weatherType = (TextView) findViewById(R.id.weather_type_khairpur);
        feelsLike = (TextView) findViewById(R.id.feels_like_khairpur);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_khairpur);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_khairpur);
        toolbar = (Toolbar) findViewById(R.id.toolbar_khairpur);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_khairpur);
        setTitle("City Weather Info");
        getData(27.5295402, 68.7634109);
    }
