...
public class MardanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mardan);
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_mardan);
        dateView = (TextView) findViewById(R.id.date_mardan);
        weatherType = (TextView) findViewById(R.id.weather_type_mardan);
        feelsLike = (TextView) findViewById(R.id.feels_like_mardan);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_mardan);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_mardan);
        toolbar = (Toolbar) findViewById(R.id.toolbar_mardan);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_mardan);
        setTitle("City Weather Info");
        getData(34.1937969, 72.0451467);
    }
