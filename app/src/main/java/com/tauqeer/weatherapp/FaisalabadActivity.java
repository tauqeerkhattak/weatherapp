...
public class FaisalabadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faisalabad);
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_faisal);
        dateView = (TextView) findViewById(R.id.date_faisal);
        weatherType = (TextView) findViewById(R.id.weather_type_faisal);
        feelsLike = (TextView) findViewById(R.id.feels_like_faisal);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_faisal);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_faisal);
        toolbar = (Toolbar) findViewById(R.id.toolbar_faisal);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_faisal);
        setTitle("City Weather Info");
        getData(31.4220558, 73.0923253);
    }
