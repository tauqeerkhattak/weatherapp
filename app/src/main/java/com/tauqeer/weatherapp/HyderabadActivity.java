...
public class HyderabadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_hyd);
        dateView = (TextView) findViewById(R.id.date_hyd);
        weatherType = (TextView) findViewById(R.id.weather_type_hyd);
        feelsLike = (TextView) findViewById(R.id.feels_like_hyd);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_hyd);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_hyd);
        toolbar = (Toolbar) findViewById(R.id.toolbar_hyd);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_hyd);
        setTitle("City Weather Info");
        getData(25.473528, 68.387862);
    }
        ...
        new AsyncTask<Void,Void,Void> () {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                if (object != null) {
                    ...
                    System.out.println("My Weather Data: "+object.toString());
                    setDataToLayout();
                }
                else {
    ...
    public static void setDataToLayout() {
        try {
            ...
            boolean bool = setNextWeekForecast();
            System.out.println("Status: "+bool);
    ...
    public static boolean setNextWeekForecast () {
        try{
            ...
            System.out.println(viewModels.get(3).getImageUrl());
            return true;
        }catch (Exception e) {
