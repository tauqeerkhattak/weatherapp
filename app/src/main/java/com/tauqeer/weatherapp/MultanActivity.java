...
public class MultanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_mul);
        dateView = (TextView) findViewById(R.id.date_mul);
        weatherType = (TextView) findViewById(R.id.weather_type_mul);
        feelsLike = (TextView) findViewById(R.id.feels_like_mul);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_mul);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_mul);
        toolbar = (Toolbar) findViewById(R.id.toolbar_mul);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_mul);
        setTitle("City Weather Info");
        getData(30.1979793, 71.4724978);
    }
