...
public class PeshawarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_pwr);
        dateView = (TextView) findViewById(R.id.date_pwr);
        weatherType = (TextView) findViewById(R.id.weather_type_pwr);
        feelsLike = (TextView) findViewById(R.id.feels_like_pwr);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_pwr);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_pwr);
        toolbar = (Toolbar) findViewById(R.id.toolbar_pwr);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_pwr);
        setTitle("City Weather Info");
        getData(34.0123846, 71.5787458);
    }
