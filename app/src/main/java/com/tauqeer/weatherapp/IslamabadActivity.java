...
public class IslamabadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_isl);
        dateView = (TextView) findViewById(R.id.date_isl);
        weatherType = (TextView) findViewById(R.id.weather_type_isl);
        feelsLike = (TextView) findViewById(R.id.feels_like_isl);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_isl);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_isl);
        toolbar = (Toolbar) findViewById(R.id.toolbar_isl);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_isl);
        setTitle("City Weather Info");
        getData(33.6938118, 73.0651511);
    }
