...
public class SibiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_sibi);
        dateView = (TextView) findViewById(R.id.date_sibi);
        weatherType = (TextView) findViewById(R.id.weather_type_sibi);
        feelsLike = (TextView) findViewById(R.id.feels_like_sibi);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_sibi);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_sibi);
        toolbar = (Toolbar) findViewById(R.id.toolbar_sibi);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_sibi);
        setTitle("City Weather Info");
        getData(29.5500097, 67.8833398);
    }
