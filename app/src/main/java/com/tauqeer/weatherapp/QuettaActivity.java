...
public class QuettaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_que);
        dateView = (TextView) findViewById(R.id.date_que);
        weatherType = (TextView) findViewById(R.id.weather_type_que);
        feelsLike = (TextView) findViewById(R.id.feels_like_que);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_que);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_que);
        toolbar = (Toolbar) findViewById(R.id.toolbar_que);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_que);
        setTitle("City Weather Info");
        getData(30.166386, 66.979205);
    }
