...
public class MurreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        mainTemp = (TextView) findViewById(R.id.viewText_murree);
        dateView = (TextView) findViewById(R.id.date_murree);
        weatherType = (TextView) findViewById(R.id.weather_type_murree);
        feelsLike = (TextView) findViewById(R.id.feels_like_murree);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_murree);
        progressBar.setIndeterminate(true);
        imageView = (ImageView) findViewById(R.id.weather_icon_murree);
        toolbar = (Toolbar) findViewById(R.id.toolbar_murree);
        toolbar.setTitle("City Weather Info");
        setSupportActionBar(toolbar);
        nextWeekForecast = (ListView) findViewById(R.id.next_week_forecast_murree);
        setTitle("City Weather Info");
        getData(33.908820, 73.394991);
    }
